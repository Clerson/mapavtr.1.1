  ...
  <div class="modal-dialog modal-lg" >
    <div class="modal-content">
      ...
      <div class="modal-header btn-warning">
        <h4 class="modal-title">Editando o Registro #<?php echo $row_detmapa["iddetmp"]; ?></h4>
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-5">
          ...
          <div class="btn-warning p-1 text-center rounded"><h5><i class="fas fa-ambulance"></i> <?php echo $row_detmapa["vtrtipo"]; ?></h5></div>
        </div>
