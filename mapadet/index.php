...
<div class="container-fluid">               
  ...
  <div class="row sticky-top">
    ...
    <ul class="navbar-nav p-1">
      ...
      <li class="nav-item ms-2"><a href='#' class='btn btn-light'  data-bs-toggle="modal" data-bs-target="#insertdetmapa" title="Adicionar nova rota"><i class="fas fa-route"></i> Adicionar</a></li>
      </li>
...
<?php 
    ...
    if(!$_GET['idvtr']) { echo "<option value=''>Selecione o motorista</option>"; } 
